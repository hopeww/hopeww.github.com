...
h2(icon-file). &#160;Adding an Documents
...
h2(icon-edit). &#160;Adding an Form


Sometimes, you like to collect information from the users.  For example, take a look at our __volunteer registration form__.  Here are the steps that need to happen.
...
Once the form is comopleted, we need to link the document the the post that you're writing.  Please be sure to change the formkey to the one that you've just created. In the example below, the formkey is __dEl4aG1zZzhNaGR6dEhRS0hCN1ZsM3c6MQ__.  Change the width & height attributes as desired.
