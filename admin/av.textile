...
h2. Where our Website is Hosted

Our website will be hosted by "GitHub":http://github.com  server.  Github is a open source code collaboration site & company.  It hosts the data like our Textile files, images, and the code for the site.  It is free for public code repositories.  I

After a textile file is created, and we have the file uploaded to the server.  The server applies some scripts that converts this Textile file into html which is what our audience sees in their web browser.

"GitHub":http://github.com uses a source control software called "git":http://git-scm.com/.  Don't worry, you don't have to know much about git for your tasks here.
