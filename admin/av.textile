...
Git is a software that allows teams of people to work on projects at the same time.  It tracks different people's changes to files over time.

We'll revisit how to use git in a little bit.
