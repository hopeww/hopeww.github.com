...
<h2> <icon class="icon-trophy"></icon>Purpose & Goals</h2>
...
<h2> <icon class="icon-star"></icon>Content is Important</h2>
...
<h2> <icon class="icon-road"></icon> &#160;Background Info</h2>
...
<h2> <icon class="icon-cog"></icon>Web Maintenance Tutorial</h2>
