...
<i class="icon-leaf"> Golden Iriah, Chapter Director </i>
...
For more information on the Toronto Chapter, please contact "(icon-envelope) &nbsp;{{ site.departments.cities.toronto-director.name }}( Toronto Chapter Director)":mailto:{{ site.departments.cities.toronto-director.email }}